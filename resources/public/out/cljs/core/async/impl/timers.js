...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__11946__auto__,writer__11947__auto__,opt__11948__auto__){return cljs.core._write.call(null,writer__11947__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_28516 = (0);while(true){
if((i_28516 < arr.length))
{(arr[i_28516] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__11946__auto__,writer__11947__auto__,opt__11948__auto__){return cljs.core._write.call(null,writer__11947__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_28523 = (self__.level + (1));while(true){
if((i_28523 <= (new_level + (1))))
{(update[i_28523] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_28525 = (0);while(true){
if((i_28525 <= self__.level))
{var links_28526 = (update[i_28525]).forward;if(((links_28526[i_28525]) === x__$1))
{(links_28526[i_28525] = (x__$1.forward[i_28525]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__11379__auto__ = (cljs.core.truth_((function (){var and__11367__auto__ = me;if(cljs.core.truth_(and__11367__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__11367__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__11379__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__11379__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__11379__auto__,timeout__$1,me))
,msecs);
