...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_28609 = (0);while(true){
var m_28610 = cljs.core.async.impl.dispatch.tasks.pop();if((m_28610 == null))
{} else
{m_28610.call(null);
if((count_28609 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__28611 = (count_28609 + (1));
count_28609 = G__28611;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__11367__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__11367__auto__)
