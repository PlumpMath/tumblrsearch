...
{{
var G__25426 = cljs.core.pop.call(null,v__$1);
v__$1 = G__25426;
continue;
}
} else
...
{var pred__25430 = cljs.core._EQ_;var expr__25431 = limit;if(cljs.core.truth_(pred__25430.call(null,(1),expr__25431)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__25430.call(null,(2),expr__25431)))
...
var G__25433 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__25434 = (limit__$1 - (1));
var G__25435 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__25433;
limit__$1 = G__25434;
parts = G__25435;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___25437 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___25437))
{var replacement_25438 = temp__4124__auto___25437;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_25438)));
} else
{buffer.append(ch);
}
{
var G__25439 = (index + (1));
index = G__25439;
continue;
}
}
